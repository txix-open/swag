...
func TestDefaultFieldParser(t *testing.T) {
	...
	t.Run("Required tag", func(t *testing.T) {
		...
		got, err = newTagBaseFieldParser(
			&Parser{},
			&ast.Field{Tag: &ast.BasicLit{
				Value: `json:"test" valid:"required"`,
			}},
		).IsRequired()
		assert.NoError(t, err)
		assert.Equal(t, true, got)
	...
	t.Run("Optional tag", func(t *testing.T) {
		...
		got, err = newTagBaseFieldParser(
			...
			&ast.Field{Tag: &ast.BasicLit{
				Value: `json:"test" valid:"optional"`,
			}},
		).IsRequired()
		assert.NoError(t, err)
		assert.False(t, got)
...
func TestValidTags(t *testing.T) {
	t.Run("Required with max/min tag", func(t *testing.T) {
		...
		err := newTagBaseFieldParser(
			&Parser{},
			&ast.Field{Tag: &ast.BasicLit{
				Value: `json:"test" valid:"required,email"`,
			}},
		).ComplementSchema(&schema)
		assert.NoError(t, err)
		...
		// 	&Parser{},
		// 	&ast.Field{Tag: &ast.BasicLit{
		// 		Value: `json:"test" valid:"required,max=10,gte=1"`,
		// 	}},
		// ).ComplementSchema(&schema)
		// assert.NoError(t, err)
		// assert.Equal(t, &max, schema.MaxLength)
		...
		// 	&Parser{},
		// 	&ast.Field{Tag: &ast.BasicLit{
		// 		Value: `json:"test" valid:"required,max=10,min=1"`,
		// 	}},
		// ).ComplementSchema(&schema)
		...
		// 	&Parser{},
		// 	&ast.Field{Tag: &ast.BasicLit{
		// 		Value: `json:"test" valid:"required,max=ten,min=1"`,
		// 	}},
		// ).ComplementSchema(&schema)
		// assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof='red book' 'green book'"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof=1 2 3"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof=red green yellow"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof='red green' blue 'c0x2Cc' 'd0x7Cd'"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof='c0x9Ab' book"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" binding:"oneof=foo bar" valid:"required,oneof=foo bar" enums:"a,b,c"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	// 	assert.Equal(t, []interface{}{"a", "b", "c"}, schema.Enum)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" binding:"oneof=aa bb" valid:"required,oneof=foo bar"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,unique"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,unique,max=10,min=1,oneof=a0x2Cc 'c0x7Cd book',omitempty,dive,max=1"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	// 	assert.Equal(t, true, schema.UniqueItems)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof=,max=10=90,min=1"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,max=10,min=one"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
	// 	assert.Equal(t, &max, schema.MaxItems)
	...
	// 		&Parser{},
	// 		&ast.Field{Tag: &ast.BasicLit{
	// 			Value: `json:"test" valid:"required,oneof=one two"`,
	// 		}},
	// 	).ComplementSchema(&schema)
	// 	assert.NoError(t, err)
