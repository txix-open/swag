...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/integration-system/swag/testdata/global_override/types.Application":  "string",
		"github.com/integration-system/swag/testdata/global_override/types.Application2": "github.com/integration-system/swag/testdata/global_override/othertypes.Application",
		"github.com/integration-system/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/integration-system/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/integration-system/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/integration-system/swag/gen"))

	parser = New(SetPackagePrefix("github.com/integration-system/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/integration-system/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/integration-system/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/integration-system/swag/gen"))

	parser = New(SetPackagePrefix("github.com/integration-system/swag/cmd,github.com/swaggo/swag/gen"))
